  ...
  <section id="app-sys-information-section" class="section js-section u-category-system">
    ...
    <div class="demo">
      <div class="demo-wrapper" :class="openDocFlag ? 'is-open' : ''">
        <button id="app-info-demo-toggle" class="js-container-target demo-toggle-button" @click.stop="openDocSection">获取应用信息
    ...
    <div class="demo">
      <div class="demo-wrapper" :class="openDocFlag ? 'is-open' : ''">
        <button id="app-version-demo-toggle" class="js-container-target demo-toggle-button" @click.stop="openDocSection">获取版本信息
          <div class="demo-meta u-avoid-clicks">支持: Win, macOS, Linux <span class="demo-meta-divider">|</span> 进程: Both</div>
        </button>
        <div class="demo-box">
          <div class="demo-controls">
...
process.versions.node</code></pre>
    ...
    <div class="demo">
      <div class="demo-wrapper" :class="openDocFlag ? 'is-open' : ''">
        <button id="sys-info-demo-toggle" class="js-container-target demo-toggle-button" @click.stop="openDocSection">获取系统信息
          <div class="demo-meta u-avoid-clicks">支持: Win, macOS, Linux <span class="demo-meta-divider">|</span> 进程: Both</div>
        </button>
        <div class="demo-box">
          <div class="demo-controls">
    ...
    <div class="demo">
      <div class="demo-wrapper" :class="openDocFlag ? 'is-open' : ''">
        <button id="screen-info-demo-toggle" class="js-container-target demo-toggle-button" @click.stop="openDocSection">获取屏幕信息
          <div class="demo-meta u-avoid-clicks">支持: Win, macOS, Linux <span class="demo-meta-divider">|</span> 进程: Both</div>
        </button>
        <div class="demo-box">
          <div class="demo-controls">
