  ...
  <section id="ipc-section" class="section js-section u-category-communication">
    ...
    <div class="demo">
      <div class="demo-wrapper" :class="openDocFlag ? 'is-open' : ''">
        <button id="async-msg-demo-toggle" class="js-container-target demo-toggle-button" @click.stop="openDocSection">异步消息
    ...
    <div class="demo">
      <div class="demo-wrapper" :class="openDocFlag ? 'is-open' : ''">
        <button id="sync-msg-demo-toggle" class="js-container-target demo-toggle-button" @click.stop="openDocSection">同步消息
          <div class="demo-meta u-avoid-clicks">支持: Win, macOS, Linux <span class="demo-meta-divider">|</span> 进程: Both</div>
        </button>
        <div class="demo-box">
          <div class="demo-controls">
    ...
    <div class="demo">
      <div class="demo-wrapper" :class="openDocFlag ? 'is-open' : ''">
        <button id="invis-msg-demo-toggle" class="js-container-target demo-toggle-button" @click.stop="openDocSection">与隐藏窗口通信
          <div class="demo-meta u-avoid-clicks">支持: Win, macOS, Linux <span class="demo-meta-divider">|</span> 进程: Both</div>
        </button>
        <div class="demo-box">
          <div class="demo-controls">
